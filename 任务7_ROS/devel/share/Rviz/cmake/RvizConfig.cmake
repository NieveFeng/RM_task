...
if("TRUE" STREQUAL "TRUE")
  set(Rviz_SOURCE_PREFIX /home/nieve/feng/RM_task/任务7_ROS/src/Rviz)
  set(Rviz_DEVEL_PREFIX /home/nieve/feng/RM_task/任务7_ROS/devel)
  set(Rviz_INSTALL_PREFIX "")
  set(Rviz_PREFIX ${Rviz_DEVEL_PREFIX})
else()
  set(Rviz_SOURCE_PREFIX "")
  set(Rviz_DEVEL_PREFIX "")
  set(Rviz_INSTALL_PREFIX /home/nieve/feng/RM_task/任务7_ROS/install)
...
if(NOT "/home/nieve/feng/RM_task/任务7_ROS/src/Rviz/include " STREQUAL " ")
  set(Rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/nieve/feng/RM_task/任务7_ROS/src/Rviz/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'nieve <nieve@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nieve/feng/RM_task/任务7_ROS/src/Rviz/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nieve/feng/RM_task/任务7_ROS/devel/lib;/home/nieve/feng/RM_task/任务7_ROS/devel/lib;/opt/ros/noetic/lib)
